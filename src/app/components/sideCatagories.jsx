...
export const Menu = () =>{
    ...
    <div className="drop flex flex-col gap-y-2 text-blue-300 mx-5 my-2 md:m-0">
        ...
        <a href="/products/trolleys?currentPage=0" className="menu-item"><span className="flex justify-between">{HeaderData[lang].trolleys} <FaArrowRightLong/></span></a>
        ...
        <a href="/products/other?currentPage=0" className="menu-item"><span className="flex justify-between">{HeaderData[lang].other} <FaArrowRightLong/></span></a>
    </div>
    )
}